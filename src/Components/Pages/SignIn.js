...
const SignIn = () => {
    ...
    return (
        <div>
            <div className='col-sm-8 mx-auto text-dark shadow-lg'
                style={{
                    display: "flex",
                ...
                <div className='content-wrap cardwrap'>
                    <form style={{ width: "100%", height: '400px' }}>
                        ...
                        <FormControl>
                            ...
                            <Input id="Username" className='mb-4' name="Username" type="text" value={Username} onChange={UsernameHandler} />
                        ...
                        <FormControl>
                            ...
                            <br />
                            <Link to={"forgot"} onClick={Forgot} style={{ color: 'red' }}>Forgot Password?</Link>
                        </FormControl>
                        <div>
